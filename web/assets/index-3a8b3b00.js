...
function El(e = {}, t) {
  const r = Ha({ ctrl: !1, command: !1, win: !1, shift: !1, tab: !1 }),
    { keydown: o, keyup: n } = e,
    i = (a) => {
      switch (a.key) {
        case "Control":
    ...
    d = () => {
      (t === void 0 || t.value) &&
        (Oe("keydown", document, i), Oe("keyup", document, l)),
        t !== void 0 &&
          Te(t, (a) => {
            a
              ? (Oe("keydown", document, i), Oe("keyup", document, l))
              : (Ie("keydown", document, i), Ie("keyup", document, l));
          });
    };
  return (
    ja()
...
function En() {
  if (
    tt === null &&
    ((tt = document.getElementById("v-binder-view-measurer")), tt === null)
  ) {
...
const Nl = q({
  ...
  Hl = {
    mounted(e, { value: t }) {
      (e[pt] = { handler: void 0 }),
        typeof t == "function" &&
          ((e[pt].handler = t), Oe("mousemoveoutside", e, t));
    },
    updated(e, { value: t }) {
      const r = e[pt];
      typeof t == "function"
        ? r.handler
          ? r.handler !== t &&
            (Ie("mousemoveoutside", e, r.handler),
            (r.handler = t),
            Oe("mousemoveoutside", e, t))
          : ((e[pt].handler = t), Oe("mousemoveoutside", e, t))
        : r.handler &&
          (Ie("mousemoveoutside", e, r.handler), (r.handler = void 0));
    },
    unmounted(e) {
  ...
  { c: Ht } = Va(),
  Ul = "vueuc-style",
  jt = { top: "bottom", bottom: "top", left: "right", right: "left" },
  Ro = { start: "end", center: "center", end: "start" },
  hr = { top: "height", bottom: "height", left: "width", right: "width" },
  Wl = {
  ...
  Mo = { top: !0, bottom: !1, left: !0, right: !1 },
  Oo = { top: "end", bottom: "start", left: "end", right: "start" };
function ql(e, t, r, o, n, i) {
  ...
  let h = l;
  return (
    t[l] < r[hr[l]] && t[l] < t[jt[l]] && (h = jt[l]),
    { placement: a !== "center" ? `${h}-${a}` : h, left: s.left, top: s.top }
  );
}
function Gl(e, t) {
  return t ? Vl[e] : Wl[e];
...
const Yl = Ht([
    Ht(".v-binder-follower-container", {
      position: "absolute",
      left: "0",
      right: "0",
      top: "0",
    ...
    Ht(".v-binder-follower-content", { position: "absolute", zIndex: "auto" }, [
      Ht("> *", { pointerEvents: "all" }),
    ]),
  ]),
  Nn = q({
    name: "Follower",
    ...
    setup(e) {
      ...
      const d = Ka();
      Yl.mount({ id: "vueuc/binder", head: !0, anchorMetaName: Ul, ssr: d }),
        nt(() => {
          l();
        }),
        Bl(() => {
        ...
        { show: this.show, to: this.mergedTo, disabled: this.teleportDisabled },
        {
          default: () => {
            ...
            return this.zindexable
              ? xt(r, [
                  [Hr, { enabled: this.mergedEnabled, zIndex: this.zIndex }],
                ])
              : r;
          },
        }
...
function Qr(e, t) {
  if (rt(e)) return !1;
  var r = typeof e;
  return r == "number" || r == "symbol" || r == "boolean" || e == null || gn(e)
    ? !0
    : ns.test(e) || !os.test(e) || (t != null && e in Object(t));
}
...
var No = "[object Map]",
  ...
  wd = St(Tr),
  ct = mn;
((Ir && ct(new Ir(new ArrayBuffer(1))) != Wo) ||
  (Pr && ct(new Pr()) != No) ||
  (_r && ct(_r.resolve()) != Ho) ||
  (Rr && ct(new Rr()) != jo) ||
  (Tr && ct(new Tr()) != Uo)) &&
...
function hc(e, t) {
  return function (r, o) {
    ...
    for (
      var n = r.length, i = t ? n : -1, l = Object(r);
      (t ? i-- : ++i < n) && o(l[i], i, l) !== !1;
...
function br(e, t) {
  ...
  if (!l)
    return o !== void 0
      ? { checkedKeys: Ou(r, o), indeterminateKeys: Array.from(i) }
      : n !== void 0
      ? { checkedKeys: Bu(r, n), indeterminateKeys: Array.from(i) }
      : { checkedKeys: Array.from(r), indeterminateKeys: Array.from(i) };
...
function Nu(e, { includeGroup: t = !1, includeSelf: r = !0 }, o) {
  ...
  for (; l; )
    !l.ignored && (t || !l.isGroup) && d.treeNodePath.push(l), (l = l.parent);
  return (
    d.treeNodePath.reverse(),
    ...
    i.forEach((l) => {
      o.push(l),
        !(l.isLeaf || !l.children || l.ignored) &&
          (l.isGroup || r === void 0 || r.has(l.key)) &&
          n(l.children);
    });
  }
  return n(e), o;
...
const Xu = {
  ...
  Zu = { name: "Empty", common: Be, self: Yu },
  Ju = Zu,
  Qu = S(
    "empty",
    `
...
`,
 ...
 `
  ...
  no = q({
    ...
    setup(e) {
      const { mergedClsPrefixRef: t, inlineThemeDisabled: r } = Re(e),
        ...
        l = D(() => {
          var u, f, h;
          return (u = e.description) !== null && u !== void 0
            ? u
            : (h =
          ...
          return (
            ((f =
              (u = i == null ? void 0 : i.mergedComponentPropsRef.value) ===
                null || u === void 0
                ? void 0
                : u.Empty) === null || f === void 0
              ? void 0
              : f.renderIcon) || (() => c(vu, null))
          );
        }),
        a = D(() => {
          const { size: u } = e,
        ...
        c(
          ...
          this.showIcon
            ? c(
                ...
                e.icon
                  ? e.icon()
                  : c(pe, { clsPrefix: t }, { default: this.mergedRenderIcon })
              )
            : null,
          this.showDescription
            ...
            : null,
          e.extra ? c("div", { class: `${t}-empty__extra` }, e.extra()) : null
        )
      );
    },
  }),
  ...
  of = { name: "Popover", common: Be, self: rf },
  io = of,
  yr = { top: "bottom", bottom: "top", left: "right", right: "left" },
 ...
 `,
          [
            ze("scrollable", [
              ze("show-header-or-footer", "padding: var(--n-padding);"),
            ]),
          ]
        ),
        B(
      ...
      (e, t) => {
        ...
        return e.map((n) => {
          const i = n.split("-")[1] === "end",
            ...
            a = Ye(n);
          return L(`[v-placement="${n}"] >`, [
            S("popover-shared", [
              j("center-arrow", [
                S(
                  "popover-arrow",
                  `${t}: calc(max(${d}, ${a}) ${i ? "+" : "-"} var(--v-offset-${
                    r ? "left" : "top"
                  }));`
                ),
              ]),
...
function je(e, t) {
  const r = e.split("-")[0],
    o = ["top", "bottom"].includes(r)
      ? "height: var(--n-space-arrow);"
      : "width: var(--n-space-arrow);";
  return L(`[v-placement="${e}"] >`, [
    S(
      "popover-shared",
      `
...
const si = Object.assign(Object.assign({}, ae.props), {
  ...
  di = ({ arrowStyle: e, clsPrefix: t }) =>
    c(
      "div",
      { key: "__popover-arrow__", class: `${t}-popover-arrow-wrapper` },
      c("div", { class: `${t}-popover-arrow`, style: e })
    ),
  af = q({
    name: "PopoverBody",
    inheritAttrs: !1,
    ...
    setup(e, { slots: t, attrs: r }) {
      ...
      const h = D(() => {
          const { trigger: z, onClickoutside: A } = e,
            $ = [],
            {
              positionManuallyRef: { value: _ },
            } = a;
          return (
            _ ||
              (z === "click" && !A && $.push([xo, b, void 0, { capture: !0 }]),
              z === "hover" && $.push([jl, k])),
            A && $.push([xo, b, void 0, { capture: !0 }]),
      ...
      a.setBodyInstance({ syncPosition: w }),
        nt(() => {
      ...
      function k(z) {
        e.trigger === "hover" &&
          !m().contains(Co(z)) &&
          a.handleMouseMoveOutside(z);
      }
      function b(z) {
        ((e.trigger === "click" && !m().contains(Co(z))) || e.onClickoutside) &&
          a.handleClickOutside(z);
      }
      function m() {
        ...
        if ($)
          A = $(
            [
              ...
              e.overlap && `${_}-popover-shared--overlap`,
              e.showArrow && `${_}-popover-shared--show-arrow`,
              e.arrowPointToCenter && `${_}-popover-shared--center-arrow`,
            ],
            s,
            p.value,
            x,
          ...
          const { value: K } = a.extraClassRef,
            ...
            C = () => {
              ...
              const H = M
                  ...
                  : e.scrollable
                  ? (T = t.default) === null || T === void 0
                    ? void 0
                    : T.call(t)
                  : c(
                      "div",
                      { class: `${_}-popover__content`, style: e.contentStyle },
                      t
                    ),
                N = e.scrollable
                  ? c(
                  ...
                  : H,
                Y = e.showArrow
                  ? di({ arrowStyle: e.arrowStyle, clsPrefix: _ })
                  : null;
              return [N, Y];
            };
          A = c(
            ...
            F ? c(al, { active: e.show, autoFocus: !0 }, { default: C }) : C()
          );
        }
        return xt(A, h.value);
      }
...
const cf = se("").type,
  ...
  ci = q({
    ...
    render() {
      ...
      if (
        !t &&
        (r.activator ? (o = ko(r, "activator")) : (o = ko(r, "trigger")), o)
      ) {
          ...
          default: () => {
            ...
            return [
              this.internalTrapFocus && i
                ? xt(c("div", { style: { position: "fixed", inset: 0 } }), [
                    [Hr, { enabled: i, zIndex: this.zIndex }],
                  ])
                : null,
              t ? null : c(Fn, null, { default: () => o }),
              c(
                af,
                xn(
                  this.$props,
                ...
                ),
                {
                  default: () => {
                    var l, d;
                    return (d = (l = this.$slots).default) === null ||
                      d === void 0
                      ? void 0
                      : d.call(l);
                  },
                  header: () => {
                    var l, d;
                    return (d = (l = this.$slots).header) === null ||
                      d === void 0
                      ? void 0
                      : d.call(l);
                  },
                  footer: () => {
                    var l, d;
                    return (d = (l = this.$slots).footer) === null ||
                      d === void 0
                      ? void 0
                      : d.call(l);
                  },
  ...
  hf = (e) => {
    ...
    return Object.assign(Object.assign({}, ff), {
      ...
      closeColorHover: $,
      closeColorPressed: _,
      borderPrimary: `1px solid ${le(n, { alpha: 0.3 })}`,
      textColorPrimary: n,
      colorPrimary: le(n, { alpha: 0.12 }),
      colorBorderedPrimary: le(n, { alpha: 0.1 }),
      closeIconColorPrimary: n,
      closeIconColorHoverPrimary: n,
      closeIconColorPressedPrimary: n,
      closeColorHoverPrimary: le(n, { alpha: 0.12 }),
      closeColorPressedPrimary: le(n, { alpha: 0.18 }),
      borderInfo: `1px solid ${le(i, { alpha: 0.3 })}`,
      textColorInfo: i,
      colorInfo: le(i, { alpha: 0.12 }),
      colorBorderedInfo: le(i, { alpha: 0.1 }),
      closeIconColorInfo: i,
      closeIconColorHoverInfo: i,
      closeIconColorPressedInfo: i,
      closeColorHoverInfo: le(i, { alpha: 0.12 }),
      closeColorPressedInfo: le(i, { alpha: 0.18 }),
      borderSuccess: `1px solid ${le(l, { alpha: 0.3 })}`,
      textColorSuccess: l,
      colorSuccess: le(l, { alpha: 0.12 }),
      colorBorderedSuccess: le(l, { alpha: 0.1 }),
      closeIconColorSuccess: l,
      closeIconColorHoverSuccess: l,
      closeIconColorPressedSuccess: l,
      closeColorHoverSuccess: le(l, { alpha: 0.12 }),
      closeColorPressedSuccess: le(l, { alpha: 0.18 }),
      borderWarning: `1px solid ${le(d, { alpha: 0.35 })}`,
      textColorWarning: d,
      colorWarning: le(d, { alpha: 0.15 }),
      colorBorderedWarning: le(d, { alpha: 0.12 }),
      closeIconColorWarning: d,
      closeIconColorHoverWarning: d,
      closeIconColorPressedWarning: d,
      closeColorHoverWarning: le(d, { alpha: 0.12 }),
      closeColorPressedWarning: le(d, { alpha: 0.18 }),
      borderError: `1px solid ${le(a, { alpha: 0.23 })}`,
      textColorError: a,
      colorError: le(a, { alpha: 0.1 }),
      colorBorderedError: le(a, { alpha: 0.08 }),
      closeIconColorError: a,
      closeIconColorHoverError: a,
      closeIconColorPressedError: a,
      closeColorHoverError: le(a, { alpha: 0.12 }),
      closeColorPressedError: le(a, { alpha: 0.18 }),
    });
  },
  pf = { name: "Tag", common: Be, self: hf },
  vf = pf,
  gf = {
    color: Object,
...
`,
 ...
 `,
        [
          ze("disabled", [
            L("&:hover", "background-color: var(--n-color-hover-checkable);", [
              ze("checked", "color: var(--n-text-color-hover-checkable);"),
            ]),
            L(
              "&:active",
 ...
 `,
            [
              ze("disabled", [
                L("&:hover", "background-color: var(--n-color-checked-hover);"),
                L(
                  "&:active",
  ...
  er = q({
    ...
    render() {
      ...
      const s = Ze(
          a.avatar,
          (f) => f && c("div", { class: `${r}-tag__avatar` }, f)
        ),
      ...
      return c(
        ...
        c(
          "span",
          { class: `${r}-tag__content`, ref: "contentRef" },
          (t = (e = this.$slots).default) === null || t === void 0
            ? void 0
            : t.call(e)
        ),
        ...
        !this.checkable && this.mergedBordered
          ? c("div", { class: `${r}-tag__border`, style: { borderColor: i } })
          : null
      );
    },
  }),
...
`,
 ...
 `,
  ...
  Or = q({
    ...
    setup(e) {
      return (
        Sn("-base-clear", wf, ee(e, "clsPrefix")),
        {
          handleMouseDown(t) {
            t.preventDefault();
          },
          ...
          default: () => {
            ...
            return this.show
              ? c(
                  ...
                  yt(this.$slots.icon, () => [
                    c(pe, { clsPrefix: e }, { default: () => c(bu, null) }),
                  ])
                )
              : c(
                  "div",
          ...
          },
          {
            default: () =>
              e.showArrow
                ? c(
                    Or,
                    { clsPrefix: r, show: e.showClear, onClear: e.onClear },
                    {
                      placeholder: () =>
                        c(
                          pe,
                          { clsPrefix: r, class: `${r}-base-suffix__arrow` },
  ...
  Sf = (e) => {
    ...
    return Object.assign(Object.assign({}, Cf), {
      ...
      boxShadowFocus: `0 0 0 2px ${le(n, { alpha: 0.2 })}`,
      loadingColor: n,
      ...
      boxShadowFocusWarning: `0 0 0 2px ${le(s, { alpha: 0.2 })}`,
      caretColorWarning: s,
      loadingColorError: f,
      ...
      boxShadowFocusError: `0 0 0 2px ${le(f, { alpha: 0.2 })}`,
      caretColorError: f,
      clearColor: A,
      clearColorHover: $,
      clearColorPressed: _,
  ...
  kf = { name: "Input", common: Be, self: Sf },
  Pf = kf,
  ui = Ge("n-input");
function $f(e) {
  let t = 0;
...
`,
 ...
 `
          ...
          L("&:-webkit-autofill ~", [B("placeholder", "display: none;")]),
        ]
      ),
      j("round", [ze("textarea", "border-radius: calc(var(--n-height) / 2);")]),
      B(
        "placeholder",
        `
 pointer-events: none;
 ...
 `
      ...
      ze("textarea", [B("placeholder", "white-space: nowrap;")]),
      B(
        "eye",
        `
 transition: color .3s var(--n-bezier);
 ...
 `
      ...
      j("pair", [
        B("input-el, placeholder", "text-align: center;"),
        B(
          "separator",
          `
 display: flex;
 ...
 `,
        [
          B("border", "border: var(--n-border-disabled);"),
          B(
            "input-el, textarea-el",
            `
 cursor: not-allowed;
 ...
 `
          ...
          B("placeholder", "color: var(--n-placeholder-color-disabled);"),
          B("separator", "color: var(--n-text-color-disabled);", [
            S(
              "icon",
              `
 ...
 `
          ...
          B("suffix, prefix", "color: var(--n-text-color-disabled);", [
            S(
              "icon",
              `
 color: var(--n-icon-color-disabled);
 ...
 `
        ...
        L("&:hover", [B("state-border", "border: var(--n-border-hover);")]),
        j("focus", "background-color: var(--n-color-focus);", [
          B(
            "state-border",
            `
    ...
    setup(e) {
      ...
      const F = D(() => {
        ...
        H = We(() => {
          ...
          const { value: g } = P,
            { value: I } = T;
          return e.pair
            ? !!(Array.isArray(g) && (g[0] || g[1])) && (A.value || I)
            : !!g && (A.value || I);
        }),
        N = D(() => {
          ...
          if (e.type === "textarea") {
            ...
            if (
              (Z &&
                (ve.value =
                  (I =
                    (g = v.value) === null || g === void 0 ? void 0 : g.$el) ===
                    null || I === void 0
                    ? void 0
                    : I.offsetWidth),
      ...
      function De(g) {
        ...
        if (I) {
          let he;
          if (
            (Z !== void 0 && (he === void 0 && (he = I(g)), he > Number(Z))) ||
            (ge !== void 0 && (he === void 0 && (he = I(g)), he < Number(Z)))
          )
            return !1;
        }
      ...
      function Ke(g) {
        Ne(g),
          ...
          (g.relatedTarget !== null &&
            (g.relatedTarget === u.value ||
              g.relatedTarget === f.value ||
              g.relatedTarget === d.value)) ||
            (_.value = !1),
          Dt(g, "blur"),
          (h.value = null);
      }
      ...
      function Dt(g, I) {
        (g.relatedTarget !== null &&
          (g.relatedTarget === u.value ||
            g.relatedTarget === f.value ||
            g.relatedTarget === d.value ||
            g.relatedTarget === l.value)) ||
          (I === "focus"
            ? (ne(g), (z.value = !0))
            : I === "blur" && (ye(g), (z.value = !1)));
      }
      function Ai(g, I) {
        $e(g, I, "change");
      }
      ...
      function Vi(g) {
        var I;
        switch (
          ((I = e.onKeydown) === null || I === void 0 || I.call(e, g), g.key)
        ) {
          case "Escape":
            sr();
            break;
...
`);
      ...
      return (
        ...
        c(
          ...
          c(
            ...
            Ze(
              a.prefix,
              (s) => s && c("div", { class: `${r}-input__prefix` }, s)
            ),
            i === "textarea"
              ? c(
                  fl,
            ...
            !this.pair &&
              Ze(a.suffix, (s) =>
                ...
                this.mergedShowPasswordOn ||
                this.loading !== void 0
                  ? c("div", { class: `${r}-input__suffix` }, [
                      Ze(
                        a["clear-icon-placeholder"],
                        (u) =>
                          (this.clearable || u) &&
                          c(
                            Or,
                            ...
                            },
                            {
                              ...
                              icon: () => {
                                var f, h;
                                return (h = (f = this.$slots)["clear-icon"]) ===
                                  null || h === void 0
                                  ? void 0
                                  : h.call(f);
                              },
          ...
          this.pair
                      ...
                      this.clearable &&
                        c(
                          ...
                          },
                          {
                            ...
                            placeholder: () => {
                              var u;
                              return (u = a["clear-icon-placeholder"]) ===
                                null || u === void 0
                                ? void 0
                                : u.call(a);
                            },
            ...
            : null,
          this.mergedBordered
            ? c("div", { class: `${r}-input__border` })
            : null,
          this.mergedBordered
            ? c("div", { class: `${r}-input__state-border` })
            : null,
  ...
  Mf = (e, t, r) => {
    ...
    i.has(o.hash)
      ? ((a = i.get(o.hash)),
        a[1].has(e) || ((d = a[0]), a[1].add(e), d.observe(e)))
  ...
  Lf = Et({ name: "Tooltip", common: Be, peers: { Popover: io }, self: Bf }),
  ao = Lf,
  Ef = Et({ name: "Ellipsis", common: Be, peers: { Tooltip: ao } }),
  Af = Ef,
  Df = {
    padding: "4px 0",
  ...
  Ff = (e) => {
    ...
    return Object.assign(Object.assign({}, Df), {
      ...
      prefixColor: r,
      optionColorHover: n,
      optionColorActive: le(t, { alpha: 0.1 }),
  ...
  Nf = Et({ name: "Dropdown", common: Be, peers: { Popover: io }, self: Ff }),
  Hf = Nf,
...
const Wf = Object.assign(Object.assign({}, ae.props), {
  ...
  hi = q({
    ...
    setup(e, { slots: t, attrs: r }) {
      const { mergedClsPrefixRef: o } = Re(e),
        ...
        s = D(() => {
          const { lineClamp: w } = e,
            { value: x } = a;
          return w !== void 0
            ? { textOverflow: "", "-webkit-line-clamp": x ? "" : w }
        ...
        c(
          ...
          Object.assign(
            ...
            Lt(r, {
              class: [
                `${o.value}-ellipsis`,
                e.lineClamp !== void 0 ? Qo(o.value) : void 0,
                e.expandTrigger === "click" ? en(o.value, "pointer") : void 0,
              ],
              style: s.value,
            }),
            {
      ...
      function y(w, x, P) {
        P === "add"
          ? w.classList.contains(x) || w.classList.add(x)
          : w.classList.contains(x) && w.classList.remove(x);
      }
      return {
        mergedTheme: n,
        triggerRef: i,
  ...
  Kf = { name: "Icon", common: Be, self: Vf },
  qf = Kf,
  Gf = S(
    "icon",
    `
    ...
    render() {
      ...
      return (
        !((e = t == null ? void 0 : t.$options) === null || e === void 0) &&
          e._n_icon__ &&
          Kr("icon", "don't wrap `n-icon` inside `n-icon`"),
        i == null || i(),
        c(
          "i",
          Lt(this.$attrs, {
...
const gi = q({
    ...
    setup(e) {
      ...
      function M() {
        ...
        Y.disabled ||
          (a.value && ((n.value = N), (o.value = null), (r.value = Y.key)));
      }
      function C() {
        const { tmNode: N } = e;
      ...
      function T(N) {
        ...
        Y &&
          !Io({ target: Y }, "dropdownOption") &&
          !Io({ target: Y }, "scrollbarRail") &&
          (r.value = null);
      }
      function H() {
        const { value: N } = b,
        ...
        a.value &&
          !N &&
          !Y.disabled &&
          (t.doSelect(Y.key, Y.rawNode), t.doUpdateShow(!1));
      }
      return {
        labelField: f,
        renderLabel: s,
          ...
          c(
            ...
            c("div", {
              class: [
                ...
                r && `${t}-dropdown-option-body__suffix--has-submenu`,
              ],
              "data-dropdown-option": !0,
            })
          )
  ...
  eh = q({
    ...
    render() {
      ...
      return c(
        Ve,
        null,
        c(Qf, { clsPrefix: r, tmNode: e, key: e.key }),
        o == null
          ? void 0
          : o.map((n) => {
              const { rawNode: i } = n;
              return i.show === !1
                ...
                ? (Kr(
                  ...
                  null)
                : c(gi, { clsPrefix: r, tmNode: n, parentKey: t, key: n.key });
            })
      );
    },
  }),
    ...
    render() {
      const { parentKey: e, clsPrefix: t, scrollable: r } = this,
        o = this.tmNodes.map((n) => {
          ...
          return i.show === !1
            ? null
            : Jf(i)
            ? c(th, { tmNode: n, key: n.key })
            : vi(i)
            ? c(pi, { clsPrefix: t, key: n.key })
            : Zf(i)
            ? c(eh, { clsPrefix: t, tmNode: n, parentKey: e, key: n.key })
            : c(gi, {
                clsPrefix: t,
                tmNode: n,
                parentKey: e,
      ...
      return c(
        ...
        r
          ...
          : o,
        this.showArrow
          ? di({ clsPrefix: t, arrowStyle: this.arrowStyle })
          : null
      );
    },
  }),
...
`,
 ...
 `
              ...
              S("dropdown-menu", "pointer-events: all;"),
            ]
          ),
          S(
 ...
 `
    ...
    setup(e) {
      const t = O(!1),
        ...
        a = D(() => {
          var F, M, C;
          return (C =
            (M = (F = i.value) !== null && F !== void 0 ? F : l.value) !==
              null && M !== void 0
              ? M
              : d.value) !== null && C !== void 0
            ? C
            : null;
        }),
          ...
          return (
            M
              ? ((ne["--n-color"] = T.colorInverted),
                ...
                (ne["--n-option-text-color-hover"] =
                  T.optionTextColorHoverInverted),
                (ne["--n-option-text-color-active"] =
                  T.optionTextColorActiveInverted),
                (ne["--n-option-text-color-child-active"] =
                  T.optionTextColorChildActiveInverted),
                (ne["--n-prefix-color"] = T.prefixColorInverted),
                (ne["--n-suffix-color"] = T.suffixColorInverted),
                (ne["--n-group-header-text-color"] =
                  T.groupHeaderTextColorInverted))
              : ((ne["--n-color"] = T.color),
  ...
  ah = { gapSmall: "4px 8px", gapMedium: "8px 12px", gapLarge: "12px 16px" },
  lh = () => ah,
  sh = { name: "Space", self: lh },
  dh = sh;
let kr;
const ch = () => {
    if (!Vr) return !0;
...
const ph = Et({ name: "Image", common: Be, peers: { Tooltip: ao }, self: hh }),
  vh = (e) => {
    const {
      textColor2: t,
      cardColor: r,
  ...
  gh = { name: "List", common: Be, self: vh },
  mh = gh,
  bh = (e) => {
    const {
      infoColor: t,
  ...
  yh = { name: "Progress", common: Be, self: bh },
  yi = yh,
  wh = {
  ...
  Ch = { name: "Result", common: Be, self: xh },
  Sh = Ch,
  kh = {
    thPaddingSmall: "6px",
  ...
  $h = { name: "Table", common: Be, self: Ph },
  zh = $h,
  Th = (e) => {
    const {
      textColor1: t,
  ...
  Ih = { name: "Thing", common: Be, self: Th },
  _h = Ih,
  Rh = (e) => {
    const {
      iconColor: t,
    ...
    return {
      ...
      itemColorHover: s,
      itemColorHoverError: le(o, { alpha: 0.06 }),
      itemTextColor: n,
  ...
  Ah = L([
    L("body >", [S("image-container", "position: fixed;")]),
    S(
 ...
 `
  ...
  wi = q({
    ...
    setup(e) {
      ...
      function R(U) {
        ...
        return (
          V.width <= window.innerWidth
            ? (De = 0)
            : V.left > 0
            ? (De = (V.width - window.innerWidth) / 2)
            : V.right < window.innerWidth
            ? (De = -(V.width - window.innerWidth) / 2)
            : fe === "horizontalRight"
            ? (De = Math.min((V.width - window.innerWidth) / 2, y - (Me ?? 0)))
            : (De = Math.max(
                -((V.width - window.innerWidth) / 2),
                y - (Me ?? 0)
              )),
          V.height <= window.innerHeight
            ? (Ke = 0)
            : V.top > 0
            ? (Ke = (V.height - window.innerHeight) / 2)
            : V.bottom < window.innerHeight
            ? (Ke = -(V.height - window.innerHeight) / 2)
            : de === "verticalBottom"
            ? (Ke = Math.min(
      ...
      function $(U) {
        ...
        if (
          ((V =
            (J = A == null ? void 0 : A.previewedImgPropsRef.value) === null ||
            J === void 0
              ? void 0
              : J.onMousedown) === null ||
            V === void 0 ||
      ...
      function oe() {
        if (M > 0.5) {
          const U = M;
          (F -= 1), (M = Math.max(0.5, Math.pow(K, F)));
          const J = U - M;
          Q(!1);
          const V = R();
      ...
      function Q(U = !0) {
        ...
        else for (const De in fe) Me += `${yc(De)}: ${fe[De]};`;
        const $e = `transform-origin: center; transform: translateX(${p}px) translateY(${v}px) rotate(${C}deg) scale(${M});`;
        k
          ? (de.cssText = Me + "cursor: grabbing; transition: none;" + $e)
          : (de.cssText =
              Me + "cursor: grab;" + $e + (U ? "" : "transition: none;")),
          U || V.offsetHeight;
      }
      function we() {
      ...
      return Object.assign(
        {
          ...
          handleDragStart: (U) => {
            var J, V;
            (V =
              (J = A == null ? void 0 : A.previewedImgPropsRef.value) ===
                null || J === void 0
                ? void 0
                : J.onDragstart) === null ||
              V === void 0 ||
                              ...
                              default: () => {
                                ...
                                return c(
                                  ...
                                  n(
                                    c(
                                      pe,
                                      { clsPrefix: r, onClick: this.zoomOut },
                                      { default: () => c(Su, null) }
                                    ),
                                    "tipZoomOut"
                                  ),
                                  n(
                                    c(
                                      pe,
                                      { clsPrefix: r, onClick: this.zoomIn },
                                      { default: () => c(Cu, null) }
                                    ),
                                    "tipZoomIn"
                                  ),
  ...
  Fh = q({
    ...
    setup(e) {
      ...
      function l(a) {
        ...
        const u = n.proxy.$el.parentElement.querySelectorAll(
          `[data-group-id=${o}]:not([data-error=true])`
        );
        if (!u.length) return;
        const f = Array.from(u).findIndex((h) => h.dataset.previewSrc === t);
        ~f
          ? i(u[(f + a + u.length) % u.length].dataset.previewSrc)
          : i(u[0].dataset.previewSrc);
      }
      _e(xi, {
  ...
  Lr = q({
    ...
    setup(e) {
      const t = O(null),
        ...
        l = {
          click: () => {
            ...
            const { value: u } = o;
            u &&
              (u.setPreviewSrc(s), u.setThumbnailEl(t.value), u.toggleShow());
          },
        },
        d = O(!e.lazy);
      et(() => {
      ...
      const a = O(!1);
      return (
        _e(bi, { previewedImgPropsRef: ee(e, "previewedImgProps") }),
        Object.assign(
          {
            mergedClsPrefix: i,
      ...
      const {
        ...
        s = c(
          ...
          Object.assign(Object.assign({}, o), {
            ...
            loading:
              wr && l && !this.intersectionObserverOptions ? "lazy" : "eager",
            style: [
              o.style || "",
              d && !n ? { height: "0", width: "0", visibility: "hidden" } : "",
 ...
 `
      ...
      return (
        ...
        c(
          "ul",
          {
            class: [
              `${r}-list`,
              this.rtlEnabled && `${r}-list--rtl`,
              this.bordered && `${r}-list--bordered`,
              this.showDivider && `${r}-list--show-divider`,
              this.hoverable && `${r}-list--hoverable`,
              this.clickable && `${r}-list--clickable`,
              this.themeClass,
            ],
            style: this.cssVars,
          },
          t.header
            ? c("div", { class: `${r}-list__header` }, t.header())
            : null,
          (e = t.default) === null || e === void 0 ? void 0 : e.call(t),
          t.footer ? c("div", { class: `${r}-list__footer` }, t.footer()) : null
        )
      );
    },
  }),
  Wh = q({
    ...
    setup() {
      const e = ue(Ci, null);
      return (
        e || Pt("list-item", "`n-list-item` must be placed in `n-list`."),
    ...
    render() {
      ...
      return c(
        ...
        { class: `${t}-list-item` },
        e.prefix
          ? c("div", { class: `${t}-list-item__prefix` }, e.prefix())
          : null,
        e.default ? c("div", { class: `${t}-list-item__main` }, e) : null,
        e.suffix
          ? c("div", { class: `${t}-list-item__suffix` }, e.suffix())
          : null,
        this.showDivider && c("div", { class: `${t}-list-item__divider` })
      );
    },
  });
function $t() {
...
const Vh = L([
 ...
 `
      ...
      j("circle, dashboard", { width: "120px" }, [
        S(
                ...
                c(
                  "div",
                  {
                    class: [
                      ...
                      v && `${y}-progress-graph-line-fill--processing`,
                    ],
                    style: {
                ...
                c(
                  ...
                  c("path", {
                    class: [
                      ...
                      a === 0 && `${p}-progress-graph-circle-fill--empty`,
                    ],
                    d: w,
                    "stroke-width": i,
                    "stroke-linecap": "round",
          ...
          s
            ? c(
                ...
                t.default
                  ? c(
                      "div",
                      { class: `${p}-progress-custom-content`, role: "none" },
                      t.default()
                    )
                  : d !== "default"
                  ? c(
                  ...
                  : c(
                      ...
                      c("span", { class: `${p}-progress-text__percentage` }, a),
                      c("span", { class: `${p}-progress-text__unit` }, f)
                    )
              )
            : null
        );
...
function on(e, t, r = 100) {
  return `m ${r / 2} ${r / 2 - e} a ${e} ${e} 0 1 1 0 ${
    2 * e
  } a ${e} ${e} 0 1 1 0 -${2 * e}`;
}
const Yh = q({
        ...
        return c(
                  ...
                  c(
                    ...
                    c("path", {
                      class: [
                        ...
                        h === 0 && `${f}-progress-graph-circle-fill--empty`,
                      ],
                      d: on(o / 2 - (n / 2) * (1 + 2 * p) - i * p, n, o),
                      "stroke-width": n,
                      "stroke-linecap": "round",
          ...
          l && t.default
            ? c(
                "div",
                null,
                c("div", { class: `${f}-progress-text` }, t.default())
              )
            : null
        );
      };
  ...
  Qh = c(
    ...
    c("circle", { fill: "#FFCB4C", cx: "18", cy: "17.018", r: "17" }),
    c("path", {
      fill: "#65471B",
  ...
  ep = c(
    ...
    c("ellipse", { fill: "#664500", cx: "18", cy: "27", rx: "5", ry: "6" }),
    c("path", {
      fill: "#664500",
  ...
  tp = c(
    "svg",
    { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 36 36" },
    c("ellipse", { fill: "#292F33", cx: "18", cy: "26", rx: "18", ry: "10" }),
    c("ellipse", { fill: "#66757F", cx: "18", cy: "24", rx: "18", ry: "10" }),
    c("path", {
      fill: "#E1E8ED",
    ...
    c("ellipse", { fill: "#A6D388", cx: "18", cy: "13", rx: "15", ry: "7" }),
    c("path", {
...
`,
 ...
 `
      ...
      S("result-content", { marginTop: "24px" }),
      S(
        "result-footer",
        `
 margin-top: 24px;
  ...
  ap = q({
    ...
    render() {
      ...
      return (
        ...
        c(
          "div",
          { class: [`${o}-result`, this.themeClass], style: this.cssVars },
          c(
            "div",
            { class: `${o}-result-icon` },
            ((e = r.icon) === null || e === void 0 ? void 0 : e.call(r)) ||
              c(pe, { clsPrefix: o }, { default: () => np[t] })
          ),
          c(
            "div",
            { class: `${o}-result-header` },
            this.title
              ? c("div", { class: `${o}-result-header__title` }, this.title)
              : null,
            this.description
              ? c(
                  "div",
          ...
          r.default && c("div", { class: `${o}-result-content` }, r),
          r.footer && c("div", { class: `${o}-result-footer` }, r.footer())
        )
      );
    },
  }),
 ...
 `
        ...
        j("striped", [
          L("tr:nth-of-type(even)", [
            L("td", "background-color: var(--n-td-color-striped)"),
          ]),
        ]),
        ze("bottom-bordered", [
          L("tr", [
    ...
    setup(e, { slots: t }) {
      ...
      return () => {
        ...
        const { value: u } = r,
          f = l ? l.value : !1;
        return (
          (s = a == null ? void 0 : a.onRender) === null ||
            s === void 0 ||
            s.call(a),
          c(
            "div",
            {
              class: [
                `${u}-thing`,
                a == null ? void 0 : a.themeClass,
                f && `${u}-thing--rtl`,
              ],
              style: o ? void 0 : d.value,
            },
            t.avatar && e.contentIndented
              ? c("div", { class: `${u}-thing-avatar` }, t.avatar())
              : null,
            c(
              "div",
              { class: `${u}-thing-main` },
              ...
              t.default || e.content
                ...
                : null,
              t.footer
                ? c("div", { class: `${u}-thing-main__footer` }, t.footer())
                : null,
              t.action
                ? c("div", { class: `${u}-thing-main__action` }, t.action())
                : null
            )
          )
        );
  ...
  fp = q({
    ...
    setup(e, { slots: t }) {
      ...
      return (
        ...
        () => {
          const {
            mergedClsPrefixRef: { value: o },
            mergedDisabledRef: { value: n },
  ...
  Ti = q({
    ...
    setup(e, { slots: t }) {
      ...
      function P(k) {
        ...
        const m =
          (b = k.dataTransfer) === null || b === void 0 ? void 0 : b.items;
        m != null && m.length
          ? mp(
              Array.from(m).map((R) => R.webkitGetAsEntry()),
              f.value
            )
              .then((R) => {
                u(R);
        ...
        return e.abstract
          ...
          : c(
              "div",
              {
                class: [
                  `${b}-upload-trigger`,
                  (n.value || i.value) && `${b}-upload-trigger--disabled`,
                  p.value && `${b}-upload-trigger--image-card`,
                ],
                style: h.value,
                onClick: v,
                onDrop: P,
              ...
              p.value
                ? c(fp, null, {
                    default: () =>
                      yt(t.default, () => [
                        c(pe, { clsPrefix: b }, { default: () => c(du, null) }),
                      ]),
                  })
                : t
            );
...
const Kt = {
  ...
  kp = q({
    ...
    setup(e) {
      ...
      function v(m) {
        ...
        ["finished", "pending", "error"].includes(R.status)
          ...
          ? P(R)
          : Kr("upload", "The button clicked type is unknown.");
      }
      function y(m) {
      ...
      function w(m) {
        ...
        Promise.resolve(
          A ? A({ file: Object.assign({}, m), fileList: $ }) : !0
        ).then((_) => {
          if (_ === !1) return;
      ...
      const b = () =>
        Sp(this, void 0, void 0, function* () {
          const { listType: m } = e;
          (m !== "image" && m !== "image-card") ||
            (t.shouldUseThumbnailUrlRef.value(e.file) &&
              (o.value = yield t.getFileThumbnailUrlResolver(e.file)));
        });
      return (
        ft(() => {
          b();
    ...
    render() {
      ...
      l || r === "image-card"
        ? (i =
            !this.shouldUseThumbnailUrl(o) || !this.mergedThumbnailUrl
              ? c(
                  "span",
                  ...
                  n
                    ? n(o)
                    : zi(o)
                    ? c(pe, { clsPrefix: e }, { default: () => xp })
                    : c(pe, { clsPrefix: e }, { default: () => Cp })
                )
              : c(
                  "a",
                  {
        ...
        : (i = c(
            "span",
            { class: `${e}-upload-file-info__thumbnail` },
            n ? n(o) : c(pe, { clsPrefix: e }, { default: () => c(cu, null) })
          ));
      const a = c(wp, {
          ...
          c(
            ...
            s &&
              (o.url && o.status !== "error"
                ...
                : c("span", { onClick: this.handlePreviewClick }, o.name)),
            l && a
          ),
          c(
            "div",
            {
              class: [
                ...
                `${e}-upload-file-info__action--${r}-type`,
              ],
            },
            this.showPreviewButton
              ? c(
                  ...
                  {
                    icon: () =>
                      c(pe, { clsPrefix: e }, { default: () => c(ii, null) }),
                  }
                )
              : null,
            ...
            this.showRetryButton &&
              ...
              c(
                ...
                {
                  icon: () =>
                    c(pe, { clsPrefix: e }, { default: () => c(yu, null) }),
                }
              ),
            this.showDownloadButton
              ? c(
                  ...
                  {
                    icon: () =>
                      c(pe, { clsPrefix: e }, { default: () => c(pu, null) }),
                  }
                )
              : null
          )
  ...
  Pp = q({
    ...
    setup(e, { slots: t }) {
      ...
      const {
        ...
        v = () =>
          l.value.map((w) =>
            c(kp, { clsPrefix: n.value, key: w.id, file: w, listType: i.value })
          ),
        y = () =>
          p.value
            ? c(Fh, Object.assign({}, h.value), { default: v })
            : c(In, { group: !0 }, { default: v });
      return () => {
        const { value: w } = n,
          { value: x } = o;
        return c(
          "div",
          {
            class: [
              `${w}-upload-file-list`,
              p.value && `${w}-upload-file-list--grid`,
              x ? (s == null ? void 0 : s.value) : void 0,
            ],
            style: [x && a ? a.value : "", d.value],
          },
          y(),
          f.value && !u.value && p.value && c(Ti, null, t)
        );
      };
    },
  }),
 ...
 `,
      [
        L("+", [S("upload-file-list", "margin-top: 8px;")]),
        j(
          "disabled",
          `
 ...
 cursor: not-allowed;
 `,
          [S("upload-file", "cursor: not-allowed;")]
        ),
        j(
          "grid",
          `
 ...
 `
                ...
                L("&:hover", [
                  L("&::before", "opacity: 1;"),
                  S("upload-file-info", [B("thumbnail", "opacity: .12;")]),
                ]),
              ]
            ),
            j("error-status", [
 ...
 `
              ...
              S("upload-file-info", [
                B("name", "color: var(--n-item-text-color-error);"),
                B("thumbnail", "color: var(--n-item-text-color-error);"),
              ]),
              j(
                "image-card-type",
                `
 ...
 `,
                  [
                    S("button", [
                      L("&:not(:last-child)", { marginRight: "4px" }),
                      S("base-icon", [L("svg", [Cn()])]),
                    ]),
                    j(
                      "image-type",
                      `
...
function zp(e, t, r) {
  ...
  function l(a) {
    ...
    n.delete(t.id),
      (u = Bt(
        ((s = e.onError) === null || s === void 0
          ? void 0
          : s.call(e, { file: u, event: a })) || u
      )),
      o(u, a);
  }
  function d(a) {
...
const Op = Object.assign(Object.assign({}, ae.props), {
  ...
  Bp = q({
    ...
    setup(e) {
      ...
      function P($, _) {
        ...
        ($ = $.filter(({ file: T, source: H }) =>
          H === "dnd" && M != null && M.trim() ? bp(T.name, T.type, M) : !0
        )),
          ...
          $.map(({ file: T, entry: H }) =>
            ln(this, void 0, void 0, function* () {
              ...
              const Y = {
                ...
                thumbnailUrl: null,
                fullPath:
                  (N = H == null ? void 0 : H.fullPath) !== null && N !== void 0
                    ? N
                    : `/${T.webkitRelativePath || T.name}`,
              };
              return !K || (yield K({ file: Y, fileList: p.value })) !== !1
                ? Y
                : null;
            })
          )
      ...
      _e(zt, {
        ...
        mergedDirectoryDndRef: D(() => {
          var $;
          return ($ = e.directoryDnd) !== null && $ !== void 0
            ? $
            : e.directory;
        }),
      });
    ...
    render() {
      ...
      if (n.default && !this.abstract) {
        const a = n.default()[0];
        !((e = a == null ? void 0 : a.type) === null || e === void 0) &&
          e[ki] &&
          (r.value = !0);
      }
      const d = c(
        ...
        : (l == null || l(),
          c(
            "div",
            {
              class: [
                `${o}-upload`,
                r.value && `${o}-upload--dragger-inside`,
                this.dragOver && `${o}-upload--drag-over`,
                this.themeClass,
              ],
              style: this.cssVars,
            },
  ...
  At = Zr(
    ...
    () => {
      const e = O([
        ...
        n = O(""),
        i = O(0),
        l = O({ isShow: !1, newPrompt: { act: "", prompt: "" } }),
        d = D(() => {
          var s;
          return n.value
            ? (s = o.value) == null
              ? void 0
              : s.filter(
                  (u) => u.act.includes(n.value) || u.prompt.includes(n.value)
                )
            : o.value;
        });
      function a(s) {
        if (s instanceof Array && s.every((u) => u.act && u.prompt)) {
          if (o.value.length === 0)
            return (
              o.value.push(...s),
              { result: !0, data: { successCount: s.length } }
            );
          const u = s.filter((f) => {
            var h;
            return (h = o.value) == null
              ? void 0
              : h.every((p) => f.act !== p.act && f.prompt !== p.prompt);
          });
          return (
            o.value.push(...u), { result: !0, data: { successCount: u.length } }
          );
        ...
        t.navConfig.url
          ? (te(),
            Se(
              ...
              Ue(t.navConfig.label),
              9,
              Lp
            ))
          : (te(), Se("div", Ep, Ue(t.navConfig.label), 1));
    },
  }),
  _i = () =>
  ...
  Fp = { class: "flex justify-center gap-3 px-8" },
  Np = { class: "flex justify-center items-center" },
  Hp = ["src"],
  jp = be(
    "p",
    { class: "text-left" },
  ...
  Up = q({
    ...
    setup(e, { emit: t }) {
      const r = e,
        ...
        i = O(""),
        l = O(!1),
        d = D({ get: () => r.show, set: (f) => t("update:show", f) }),
        a = () => {
          if (!n.value) {
            o.error("请先输入关键词");
            return;
          ...
          (l.value = !0),
            (i.value = `/images/create?re=1&showselective=1&sude=1&kseed=7500&SFX=2&q=${encodeURIComponent(
              n.value
            )}&t=${Date.now()}`);
        },
        s = () => {
          ...
          },
          {
            default: X(() => [
              be("head", Fp, [
                ...
                G(
                  E(ce),
                  { secondary: "", type: "info", onClick: a, loading: l.value },
                  { default: X(() => [se("开始创建")]), _: 1 },
                  8,
                  ["loading"]
                ),
              ]),
                  ...
                  ? (te(),
                    Se(
                      "iframe",
                      {
                        key: 0,
                        class:
                          "w-[310px] h-[350px] xl:w-[475px] xl:h-[520px] my-4",
                        src: i.value,
                        frameborder: "0",
                  ...
                  : (te(),
                    ke(
                      E(no),
                      {
                        key: 1,
                        class:
                          "h-[40vh] xl:h-[60vh] flex justify-center items-center",
                        description: "暂未创建",
                      },
                      {
                        extra: X(() => [
                          G(
                            E(ce),
                            { secondary: "", type: "info", onClick: u },
                            { default: X(() => [se("使用示例创建")]), _: 1 }
                          ),
                          be("div", { class: "text-[#c2c2c2] px-2 xl:px-10" }, [
                            jp,
                            be("p", { class: "text-left" }, "示例：" + Ue(dn)),
                          ]),
                        ]),
                        _: 1,
                      }
  ...
  co = Zr(
    ...
    () => {
      const e = "/sydney/ChatHub",
        ...
        r = O(""),
        o = O([
          { baseUrl: "https://sydney.bing.com", label: "Bing 官方" },
          { baseUrl: "https://sydney.vcanbb.chat", label: "Cloudflare" },
          { baseUrl: location.origin, label: "本站" },
          { baseUrl: "", label: "自定义", isCus: !0 },
        ]),
        n = 3e3,
        i = async (d) => {
            ...
            return (
              await new Promise((f, h) => {
                (s.onopen = () => {
                  ...
                  (s.onclose = () =>
                    h(new Error(`聊天服务器 ${d.baseUrl} 连接超时`)));
              }),
...
var uo = ((e) => (
  (e[(e.OK = 200)] = "OK"), (e[(e.Unauthorized = 401)] = "Unauthorized"), e
))(uo || {});
const Ri = Zr(
    "user-store",
    () => {
      const t = "_U",
        ...
        l = () => {
          const v = new Date();
          return (
            v.setMinutes(v.getMinutes() + CIB.config.sydney.expiryInMinutes), v
          );
        },
        d = async (v = 0) => {
          var w;
          ...
          const y = await fetch("/turing/conversation/create", {
            ...
            .then((x) => x.json())
            .catch((x) => "error");
          ((w = y == null ? void 0 : y.result) == null ? void 0 : w.value) ===
          "Success"
            ? (console.log("成功创建会话ID : ", y.conversationId),
              CIB.manager.conversation.updateId(
                y.conversationId,
                l(),
                y.clientId,
                y.conversationSignature
              ))
            : (await Dp(300),
              (v += 1),
        ...
        s = () => {
          a() ||
            ((CIB.config.features.enableGetChats = !1),
        ...
        h = async () => {
          ...
          for (const y of v)
            await caches.delete(y), console.log("del cache : ", y);
        };
      return {
        sysConfig: n,
        getSysConfig: i,
  ...
  Yp = q({
    ...
    setup(e) {
      const t = O(!1),
        ...
        p = [
          { key: h.version, label: "版本信息" },
          { key: h.chatService, label: "服务选择" },
          { key: h.promptStore, label: "提示词库" },
          { key: h.setToken, label: "设置用户" },
          { key: h.compose, label: "撰写文章", url: "/web/compose.html" },
          { key: h.createImage, label: "图像创建" },
          { key: h.reset, label: "一键重置" },
        ],
        v = (P) => c(Ap, { navConfig: P }),
        y = (P) => {
          var k;
          switch (P) {
            case h.version:
            ...
            case h.setToken:
              ...
              break;
            case h.createImage:
              !((k = f.sysConfig) != null && k.isSysCK) &&
                !f.getUserToken() &&
                n.warning("体验画图功能需先登录"),
                (a.value = !0);
              break;
            case h.reset:
              d.value = !0;
            ...
            G(
              ...
              },
              {
                ...
                action: X(() => [
                  G(
                    E(ce),
                    { ghost: "", size: "large", type: "info", onClick: ()=>{
                       window.open("/web/help.html")
                    } },
                    { default: X(() => [se("帮助")]), _: 1 }
                  ),
                  G(
                  ...
                  G(
                    E(ce),
                    { ghost: "", size: "large", type: "info", onClick: x },
                    { default: X(() => [se("保存")]), _: 1 }
                  ),
                ]),
                default: X(() => [
            ...
            G(
              ...
              },
              {
                ...
                action: X(() => [
                  ...
                  G(
                    E(ce),
                    { ghost: "", size: "large", type: "error", onClick: w },
                    { default: X(() => [se("确定")]), _: 1 }
                  ),
                ]),
                _: 1,
...
var vt = { FRONT: "FRONT", BEHIND: "BEHIND" },
  dt = { INIT: "INIT", FIXED: "FIXED", DYNAMIC: "DYNAMIC" },
  fn = 2,
  iv = (function () {
    function e(t, r) {
    ...
    return (
      Jp(e, [
        ...
        },
        {
          ...
          value: function (r) {
            return (
              (r < 1 ? 0 : this.getIndexOffset(r)) + this.param.slotHeaderSize
            );
          },
        },
        {
          ...
          value: function (r, o) {
            ...
            this.param &&
              r in this.param &&
              (r === "uniqueIds" &&
                this.sizes.forEach(function (i, l) {
        ...
        },
        {
          ...
          value: function (r, o) {
            this.sizes.set(r, o),
              this.calcType === dt.INIT
                ? ((this.fixedSizeValue = o), (this.calcType = dt.FIXED))
                : this.calcType === dt.FIXED &&
                  this.fixedSizeValue !== o &&
                  ((this.calcType = dt.DYNAMIC), delete this.fixedSizeValue),
              this.calcType !== dt.FIXED &&
                typeof this.firstRangeTotalSize < "u" &&
                (this.sizes.size <
                Math.min(this.param.keeps, this.param.uniqueIds.length)
                  ? ((this.firstRangeTotalSize = ev(this.sizes.values()).reduce(
                      function (n, i) {
                        return n + i;
                      },
                      0
        ...
        },
        {
          ...
          value: function (r) {
            (this.direction = r < this.offset ? vt.FRONT : vt.BEHIND),
              (this.offset = r),
              this.param &&
                (this.direction === vt.FRONT
                  ? this.handleFront()
                  : this.direction === vt.BEHIND && this.handleBehind());
          },
        },
        {
          key: "handleFront",
        ...
        },
        {
          ...
          value: function () {
            var r = this.getScrollOvers();
            r < this.range.start + this.param.buffer ||
        ...
        },
        {
          ...
          value: function () {
            ...
            for (
              var o = 0, n = 0, i = 0, l = this.param.uniqueIds.length;
              o <= l;

            ) {
              if (
                ((n = o + Math.floor((l - o) / 2)),
        ...
        },
        {
          ...
          value: function (r) {
            ...
            return (
              (this.lastCalcIndex = Math.max(this.lastCalcIndex, r - 1)),
        ...
        },
        {
          ...
          value: function () {
            var r = this.range.end,
              o = this.getLastIndex();
            return this.isFixedType()
              ? (o - r) * this.fixedSizeValue
              : this.lastCalcIndex === o
              ? this.getIndexOffset(o) - this.getIndexOffset(r)
              : (o - r) * this.getEstimateSize();
          },
        },
        {
          key: "getEstimateSize",
...
var Oi = q({
  ...
  setup: function (t, r) {
    ...
    var h = function (C) {
      ...
      p = function () {
        return t.pageMode
          ? document.documentElement[d] || document.body[d]
          : s.value
          ? Math.ceil(s.value[d])
          : 0;
      },
      v = function () {
        ...
        return t.pageMode
          ? document.documentElement[C] || document.body[C]
          : s.value
          ? Math.ceil(s.value[C])
          : 0;
      },
      ...
      w = function (C, T, H, N) {
        o("scroll", N, f.getRange()),
          f.isFront() && t.dataSources.length && C - t.topThreshold <= 0
            ? o("totop")
            : f.isBehind() && C + T + t.bottomThreshold >= H && o("tobottom");
      },
      x = function (C) {
        var T = p(),
          H = v(),
      ...
      R = function (C) {
        t.pageMode
          ? ((document.body[d] = C), (document.documentElement[d] = C))
          : s.value && (s.value[d] = C);
      },
      z = function () {
        for (
          ...
          if (ne) {
            ...
            typeof Le == "string" || typeof Le == "number"
              ? C.push(
                  G(
                    dv,
                    {
                      ...
                      class: ""
                        .concat(ve)
                        .concat(t.itemClassAdd ? " " + t.itemClassAdd(ye) : ""),
                      onItemResize: A,
                    },
                    null
                  )
              ...
              : console.warn(
                  "Cannot get the data-key '".concat(re, "' from data-sources.")
                );
          } else
            console.warn(
              "Cannot get the index '".concat(ye, "' from data-sources.")
            );
        }
        return C;
      },
      ...
      $ = function (C, T, H) {
        C === mt.HEADER
          ? f.updateParam("slotHeaderSize", T)
          : C === mt.FOOTER && f.updateParam("slotFooterSize", T),
    ...
    return (
      ...
      et(function () {
        t.start ? m(t.start) : t.offset && R(t.offset),
          t.pageMode &&
            (K(), document.addEventListener("scroll", x, { passive: !1 }));
      }),
      _n(function () {
      ...
      function () {
        var M = t.pageMode,
          ...
          ne = {
            padding: l
              ? "0px ".concat(ye, "px 0px ").concat(we, "px")
              : "".concat(we, "px 0px ").concat(ye, "px"),
          },
...
const cv = {
    class:
      "inline-block max-w-[120px] xl:max-w-[650px] overflow-hidden text-ellipsis",
  },
  uv = { class: "float-right" },
  fv = q({
      ...
      const t = $t(),
        ...
        i = (d) => {
          (o.value = o.value.filter(
            (a) => a.act !== d.act && a.prompt !== d.prompt
          )),
            t.success("删除提示词成功");
        },
        l = (d) => {
        ...
        ke(
          ...
          { class: "hover:bg-gray-100 cursor-pointer p-5" },
          {
            ...
            default: X(() => [
              G(
                E(hi),
                { tooltip: !1, "line-clamp": 2 },
                { default: X(() => [se(Ue(d.source.prompt), 1)]), _: 1 }
              ),
            ]),
            _: 1,
          }
  ...
  hv = { class: "flex justify-start flex-wrap gap-2 px-5 pb-2" },
  pv = ["href"],
  vv = { class: "flex justify-center gap-5" },
  gv = ["href"],
  mv = q({
    ...
    setup(e) {
      const t = $t(),
        ...
        p = () => {
          ...
          if (k === "add")
            (i.value = [m, ...i.value]), t.success("添加提示词成功");
          else if (k === "edit") {
            if (
              m.act === (b == null ? void 0 : b.act) &&
              m.prompt === (b == null ? void 0 : b.prompt)
            ) {
              t.warning("提示词未变更"), (a.value.isShow = !1);
              return;
            }
            const R = i.value.findIndex(
              (z) =>
                z.act === (b == null ? void 0 : b.act) &&
                z.prompt === (b == null ? void 0 : b.prompt)
            );
            R > -1
              ? ((i.value[R] = m), t.success("编辑提示词成功"))
              : t.error("编辑提示词出错");
          }
          a.value.isShow = !1;
        },
        ...
        y = async (k) => {
          ...
          if (k.file.file) {
            ...
            const m = await v(k.file.file),
              ...
              z = r.addPrompt(R);
            z.result
              ? (t.info(`上传文件含 ${R.length} 条数据`),
                t.success(
                  `成功导入 ${
                    (b = z.data) == null ? void 0 : b.successCount
                  } 条有效数据`
                ))
              : t.error(z.msg || "提示词格式有误"),
              (u.value = !1);
          } else t.error("上传文件有误");
        },
        w = () => {
          ...
          const k = JSON.stringify(i.value),
            b = new Blob([k], { type: "application/json" }),
...
`
            ...
            return (
              (k.isDownloading = !1), t.error("暂不支持下载此后缀的提示词")
            );
          k.isDownloading = !1;
          const m = r.addPrompt(b);
          m.result
            ? (t.info(`下载文件含 ${b.length} 条数据`),
              t.success(
                `成功导入 ${
                  (R = m.data) == null ? void 0 : R.successCount
                } 条有效数据`
              ))
            : t.error(m.msg || "提示词格式有误");
        };
      return (k, b) => (
        te(),
        Se(
              ...
              },
              {
                default: X(() => [
                  be("div", hv, [
                    ...
                    G(
                      E(ce),
                      { secondary: "", type: "error", onClick: x },
                      { default: X(() => [se("清空")]), _: 1 }
                    ),
                  ]),
                  E(d).length > 0
...
@media screen and (max-width: 767px) {\r
  ...
  yv = {
    class:
      "inline-block max-w-[310px] xl:max-w-[650px] overflow-hidden text-ellipsis",
  },
  wv = q({
    __name: "ChatPromptItem",
    props: { index: {}, source: {} },
    setup(e) {
      const t = At(),
        ...
        i = (l) => {
          l &&
            ((n.value = ""),
            (CIB.vm.actionBar.inputText = l.prompt),
      ...
      return (l, d) => (
        ...
        ke(
          ...
          {
            class: Mn([
              "hover:bg-gray-100 cursor-pointer px-5 h-[130px] flex justify-start items-center",
  ...
  xv = { key: 0, class: "loading-spinner" },
  Cv = fo(() => be("div", { class: "bounce1" }, null, -1)),
  Sv = fo(() => be("div", { class: "bounce2" }, null, -1)),
  kv = fo(() => be("div", { class: "bounce3" }, null, -1)),
  Pv = [Cv, Sv, kv],
  $v = q({
    __name: "LoadingSpinner",
    props: { isShow: { type: Boolean } },
    setup(e) {
      return (t, r) => (
        te(),
        ke(
...
const zv = (e, t) => {
  ...
  Iv = { key: 0, class: "hidden lg:block" },
  _v = { key: 1 },
  Rv = { class: "hidden lg:table-cell" },
  Mv = { key: 1 },
  Ov = { key: 0, class: "flex justify-center items-center flex-wrap gap-2" },
  Bv = ["onClick"],
  Lv = { class: "flex justify-center items-center flex-wrap gap-2" },
  Ev = q({
                        ...
                        Rn(
                          ...
                          (f, h) => (
                            ...
                            Se("tr", { key: h }, [
                              be("td", null, [
                                f.isCus
                                  ? (te(), Se("span", Iv, Ue(f.label), 1))
                                  : (te(), Se("span", _v, Ue(f.label), 1)),
                                f.isCus
                                  ? (te(),
                                    ke(
                                      E(Qe),
  ...
  Dv = {
    key: 0,
    class:
      "fixed top-0 left-0 w-screen h-screen flex justify-center items-center bg-black/40 z-50",
  },
  Fv = 130,
  Nv = q({
    __name: "Chat",
    setup(e) {
      const t = $t(),
        ...
        m = D(
          () =>
            (CIB.vm.isMobile && CIB.vm.sidePanel.isVisibleMobile) ||
            (!CIB.vm.isMobile && CIB.vm.sidePanel.isVisibleDesktop)
        );
      et(async () => {
        await _(),
          R(),
      ...
      const R = () => {},
        ...
        K = () => {
          ...
          location.hostname === "localhost" &&
            (CIB.config.sydney.hostnamesToBypassSecureConnection =
              CIB.config.sydney.hostnamesToBypassSecureConnection.filter(
                (de) => de !== location.hostname
              ));
          const W = document.querySelector("cib-serp");
          W == null || W.setAttribute("alignment", "center");
          const oe =
              (ye = W == null ? void 0 : W.shadowRoot) == null
                ? void 0
                : ye.querySelector("cib-conversation"),
            Q =
              (ne = oe == null ? void 0 : oe.shadowRoot) == null
                ? void 0
                : ne.querySelector("cib-welcome-container");
          (Ne =
            (Le = Q == null ? void 0 : Q.shadowRoot) == null
              ? void 0
              : Le.querySelector(".learn-tog-item")) == null || Ne.remove(),
            (Ee =
              (He = W == null ? void 0 : W.shadowRoot) == null
                ? void 0
                : He.querySelector("cib-serp-feedback")) == null || Ee.remove(),
            _i() &&
              ((J =
                (U = Q == null ? void 0 : Q.shadowRoot) == null
                  ? void 0
                  : U.querySelector(".container-item")) == null || J.remove(),
              (CIB.vm.actionBar.input.placeholder =
                '有问题尽管问我...（"/" 触发提示词）'));
        ...
        F = () => {
          ...
          const W =
              (we =
                (Q = document.querySelector("#b_sydConvCont > cib-serp")) ==
                null
                  ? void 0
                  : Q.shadowRoot) == null
                ? void 0
                : we.querySelector("#cib-action-bar-main"),
        ...
        T = (W) => {
          var oe;
          w.value ||
            ((W instanceof InputEvent || W instanceof CompositionEvent) &&
              W.target instanceof HTMLTextAreaElement &&
              ((oe = W.target.value) != null && oe.startsWith("/")
                ? ((i.value = !0),
        ...
        Y = (W) => {
          switch (W.key) {
            case "ArrowUp":
              s.value > 0 &&
                (s.value--, y.value && y.value.scrollToIndex(s.value));
              break;
            case "ArrowDown":
              s.value < a.value.length - 1 &&
                (s.value++, y.value && y.value.scrollToIndex(s.value));
              break;
            case "Tab":
            case "Enter":
              {
                if (
                  !CIB.vm.actionBar.inputText ||
                  !CIB.vm.actionBar.inputText.startsWith("/")
                )
                  return;
                re(a.value[s.value]);
              }
        ...
        re = (W) => {
          W &&
            ((l.value = ""),
            (CIB.vm.actionBar.inputText = W.prompt),
            (i.value = !1));
        },
        ve = () => {
          (x.value = !0),
            setTimeout(() => {
              ...
              if (x.value === !0) {
                x.value = !1;
                const oe =
                  ((W = y.value) == null ? void 0 : W.getOffset()) || 0;
        ...
        Ce = async () => {
          ...
          const W = await v.getSysConfig();
          W.data.isAuth
            ? (t.success("授权成功"), (P.value = !1), $(W.data))
            : t.error("授权码有误"),
            (b.value = !1);
        };
      return (W, oe) => (
        ...
        Se(
          ...
          null,
          [
            G(Tv, { "is-show": r.value }, null, 8, ["is-show"]),
            be("main", null, [
              E(i)
                ? (te(),
                  Se(
                    "div",
                    {
                      key: 0,
                      class: Mn([
                        "box-border fixed bottom-[110px] w-full flex justify-center px-[14px] md:px-[34px] z-999",
                        { "md:px-[170px]": m.value, "xl:px-[220px]": m.value },
                      ]),
                    },
                    [
                      Av,
                        ...
                        ? (te(),
                          ke(
                            E(Oi),
                            {
                              ...
                              ref: y,
                              class:
                                "bg-white w-full max-w-[1060px] max-h-[390px] rounded-xl overflow-y-auto",
                              "data-key": "prompt",
                              "data-sources": E(a),
                              "data-component": wv,
                              keeps: 10,
                        ...
                        : (te(),
                          ke(
                            E(no),
                            {
                              key: 1,
                              class:
                                "bg-white w-full max-w-[1060px] max-h-[390px] rounded-xl py-6",
                ...
                ? (te(),
                  Se("div", Dv, [
                    G(
                      ...
                      {
                        class:
                          "box-border w-11/12 lg:w-[400px] px-4 py-4 bg-white rounded-md",
                        status: "403",
                        title: "401 未授权",
                      },
                      {
